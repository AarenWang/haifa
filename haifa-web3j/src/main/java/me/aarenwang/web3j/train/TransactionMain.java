...
public class TransactionMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        web3j.ethGetTransactionReceipt(hash).send().getTransactionReceipt().ifPresentOrElse(receipt -> {
            ...
            sb.append("BaseFeePerGas: ").append(getBlock(web3j,receipt.getBlockHash()).getBaseFeePerGas()).append("\n");
            System.out.println(sb.toString());
        }, () -> {
    ...
    private static EthBlock.Block getBlock(Web3j web3j, String blockHash) {
        try {
