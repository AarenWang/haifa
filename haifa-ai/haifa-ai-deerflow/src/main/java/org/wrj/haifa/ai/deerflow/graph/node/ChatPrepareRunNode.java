...
public class ChatPrepareRunNode implements AsyncNodeAction {
    ...
    private Map<String, Object> prepare(OverAllState state) {
        ...
        GraphChatLifecycleContext lifecycle = requireLifecycle(view.runId());
    ...
    private static GraphChatLifecycleContext requireLifecycle(String runId) {
        return GraphChatLifecycleRegistry.get(runId)
